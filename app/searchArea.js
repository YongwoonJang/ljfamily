...
export default function SearchArea({ isFocus, setFocus }) {
    const data = [
        { condition: "new", category: "album", title: "미미치치는 무섭다", url: "/images/family/202309231900__sister_무서운 누루하치.jpg"},
        { condition: "new", category: "album", title: "잠자는 숲속의 하성", url: "/images/family/202309251200_son_잠자는 숲속의 하성.jpg" },
